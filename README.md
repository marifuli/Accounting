...
2. Transaction name, category_id, from_account_id, to_account_id [both will foreign_Id], description , attachment multiple, send_total_amount, send_actual_amount, receive_total_amount, receive_actual_amount
3. transaction_fees name, amount , enum [from , to], transaction_id (foreign id not constrant)
