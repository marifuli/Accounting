...
const breadcrumbs = [{ title: 'Accounts', href: '/accounts' }, { title: 'Create' }];
        ...
        <div class="container mx-auto max-w-5xl p-4 sm:p-6 lg:p-8">
            ...
            <form @submit.prevent="submit" class="grid gap-6">
                ...
                <section v-if="isCard" class="rounded-xl border border-gray-200 p-4 dark:border-gray-800">
                    ...
                    <p class="mt-2 text-xs text-amber-600 dark:text-amber-400">Tip: avoid storing real CVV/PIN in production systems.</p>
                </section>
