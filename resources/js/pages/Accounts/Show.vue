  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="container mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
          ...
          <div class="mt-2 flex flex-wrap gap-2">
            ...
            <span
              ...
              :class="{
                ...
                'bg-gray-100 text-gray-800 dark:bg-gray-800 dark:text-gray-200': !['bank','mobile','card'].includes(String(props.account.type ?? ''))
              }"
            >
              {{ props.account.type ?? '—' }}
            </span>
      ...
      <div class="grid gap-6 md:grid-cols-2">
        ...
        <section v-if="props.account.type === 'card'" class="rounded-xl border border-gray-200 p-4 dark:border-gray-800 md:col-span-2">
          ...
          <dl class="grid grid-cols-3 gap-3 text-sm">
            ...
            <dd class="col-span-2 font-mono">
              <!-- CVV should not be shown in real apps; masked here -->
              {{ props.account.card_type ? '•••' : '—' }}
            </dd>
          ...
          <p class="mt-3 text-xs text-amber-600 dark:text-amber-400">
            For security, avoid storing or displaying CVV/PIN in production.
          </p>
        </section>
      </div>
    </div>
