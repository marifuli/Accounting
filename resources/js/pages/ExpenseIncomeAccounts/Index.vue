...
const rowStart = computed(() => Number(props.expenseIncomeAccounts.from ?? 1));
</script>
        ...
        <div class="h-full w-full p-4">
            ...
            <table class="min-w-full text-left text-sm">
              ...
              <tbody>
                <tr v-if="!props.expenseIncomeAccounts?.data?.length">
                  <td colspan="7" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">No records found.</td>
                </tr>

                <tr
                  v-for="(row, i) in props.expenseIncomeAccounts.data"
                  :key="row.id"
          ...
          <div v-if="props.expenseIncomeAccounts?.links?.length" class="mt-4 flex items-center justify-between gap-3">
            <p class="text-xs text-gray-500 dark:text-gray-400">
              Showing {{ props.expenseIncomeAccounts.from ?? 0 }}–{{ props.expenseIncomeAccounts.to ?? props.expenseIncomeAccounts.data.length }}
