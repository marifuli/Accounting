...
const breadcrumbs = [{ title: 'Expense/Income Accounts', href: route('expense-income-accounts.index') }, { title: 'Edit' }];

const form = useForm({
    name: props.expense_income_account.name ?? '',
    current_balance: props.expense_income_account.current_balance ?? 0,
