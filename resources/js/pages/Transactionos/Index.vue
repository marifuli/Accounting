...
type TransactionRow = {
  ...
  // relations come snake_cased from Laravel when the relation method is camelCased
  category?: Rel | null
        ...
        <div class="h-full w-full p-4">
            ...
            <table class="min-w-full text-left text-sm">
              ...
              <tbody>
                <tr v-if="!props.transactions?.data?.length">
                  <td colspan="8" class="px-4 py-8 text-center text-gray-500 dark:text-gray-400">No transactions found.</td>
                </tr>
          ...
          <div v-if="props.transactions?.links?.length" class="mt-4 flex items-center justify-between gap-3">
            <p class="text-xs text-gray-500 dark:text-gray-400">
              Showing {{ props.transactions.from ?? 0 }}–{{ props.transactions.to ?? props.transactions.data.length }}
              of {{ props.transactions.total }}
            </p>
