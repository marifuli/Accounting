...
const breadcrumbs = [{ title: 'Upcoming E/I', href: route('upcomming-expense-income.index') }, { title: 'Edit' }];
...
const form = useForm({
    ...
    // NEW
    amount: props.upcomming_expense_income.amount ?? '',
    currency: props.upcomming_expense_income.currency ?? 'BDT',
});
...
function submit() {
    form.transform((data) => {
        ...
        fd.append('currency', String(data.currency ?? 'BDT'));
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="container mx-auto max-w-4xl p-4 sm:p-6 lg:p-8">
            ...
            <form @submit.prevent="submit" class="grid gap-6">
                ...
                <section class="rounded-xl border border-gray-200 p-4 dark:border-gray-800">
                    <h2 class="mb-4 text-sm font-semibold tracking-wide text-gray-500 uppercase dark:text-gray-400">Existing Attachments</h2>
                ...
                <!-- Add new attachments -->
                <section class="rounded-xl border border-gray-200 p-4 dark:border-gray-800">
                    <h2 class="mb-4 text-sm font-semibold tracking-wide text-gray-500 uppercase dark:text-gray-400">Add Attachments</h2>
