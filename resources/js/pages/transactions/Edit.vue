        ...
        <div class="container mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
            <div class="grid gap-6 lg:grid-cols-2">
                ...
                <aside class="rounded-xl border border-gray-200 p-4 dark:border-gray-800">
                    <h2 class="mb-3 text-sm font-semibold tracking-wide text-gray-500 uppercase dark:text-gray-400">Meta</h2>
                    <div class="space-y-2 text-sm text-gray-700 dark:text-gray-300">
                        <div><strong>Created:</strong> {{ props.transaction.created_at ?? '—' }}</div>
                        <div><strong>Updated:</strong> {{ props.transaction.updated_at ?? '—' }}</div>
                    </div>
                </aside>
            </div>
        </div>
