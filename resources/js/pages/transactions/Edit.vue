  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    <div class="container mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
      <div class="grid gap-6 lg:grid-cols-2">
        ...
        <section class="rounded-xl border border-gray-200 p-4 dark:border-gray-800">
          ...
          <form @submit.prevent="submit" class="grid gap-6">
              ...
              <div class="mt-4">
                ...
                <div class="mt-3 grid gap-3 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input
                      :value="(n(form.send_actual_amount) - sourceFeesTotal).toFixed(2)"
                      type="text" readonly
              ...
              <div class="mt-4">
                ...
                <div class="mt-3 grid gap-3 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input
                      :value="(n(form.receive_actual_amount) - destFeesTotal).toFixed(2)"
                      type="text" readonly
                      class="w-full cursor-not-allowed rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 dark:border-gray-800 dark:bg-gray-900/40"
                    />
                  </div>
            ...
            <div>
              ...
              <textarea v-model="form.description" rows="3" class="w-full rounded-lg border border-gray-300 px-3 py-2 dark:border-gray-700" />
            </div>
            ...
            <div>
              ...
              >
                <li v-for="(p, i) in existingAttachments" :key="`${p}-${i}`" class="flex items-center justify-between px-3 py-2">
                  <span class="truncate">{{ filename(p) }}</span>
                  <a :href="fileUrl(p)" target="_blank" rel="noopener" class="rounded-md border px-2 py-1 text-xs hover:bg-gray-50 dark:hover:bg-gray-800">View</a>
                </li>
              </ul>

              <label class="mb-1 block text-sm font-medium">Add New Attachments</label>
              <input
                type="file" multiple @change="onFilesChanged"
        ...
        <!-- RIGHT: Calculator (70%) -->
        <aside class="relative rounded-xl border border-gray-200 p-4 dark:border-gray-800">
          ...
          <div class="origin-top-left scale-[0.70] transform">
            <div class="space-y-3">
              ...
              <div class="relative">
                <input :value="calc.result" readonly class="w-full rounded-lg border border-gray-200 bg-gray-50 px-3 py-2 text-right text-base pr-16 dark:border-gray-800 dark:bg-gray-900/40" placeholder="Result" />
                <button type="button" class="absolute inset-y-0 right-2 my-auto h-8 rounded-md border px-2 text-xs hover:bg-gray-50 dark:hover:bg-gray-800" @click="copyResult">
                  Copy
                </button>
              </div>
          ...
          <transition name="fade">
            <div v-if="toast.show" class="pointer-events-none absolute right-3 top-3 rounded-md bg-gray-900/90 px-3 py-1.5 text-xs text-white shadow">
              {{ toast.text }}
            </div>
          </transition>
        </aside>
