                ...
                <div class="h-full w-full p-4">
                    ...
                    <div class="overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-800">
                        <table class="min-w-full text-left text-sm">
                            ...
                            <tbody>
                                ...
                                <tr
                                    v-for="row in props.transactionCategories.data"
                                    :key="row.id"
                    ...
                    <div v-if="props.transactionCategories?.links?.length" class="mt-4 flex items-center justify-between gap-3">
                        <p class="text-xs text-gray-500 dark:text-gray-400">
                            Showing {{ props.transactionCategories.from ?? 0 }}–{{
                                props.transactionCategories.to ?? props.transactionCategories.data.length
                            }}
